export const JP = {
    Translator: "翻訳者",
    TranslatorName: "etyucat, taku1417, nakawankuma",
    Language: "言語",
    ThisLanguage: "日本語",
    OK: "OK",
    SteelMill: "製鋼所",
    ...
    InputStrategyCloseDesc: "資源が十分にある最も近い施設から納入する",
    InputStrategyFar: "遠くから",
    InputStrategyFarDesc: "資源が十分にある最も遠い施設から納入する",
    InputStrategyAmount: "多い所から",
    InputStrategyAmountDesc: "距離に関係なく資源の量が多い施設から納入する",
    FuelCostSave: "燃料節約率",
    FuelCostSaveDescV2:
    ...
    Reindeer: "トナカイ",
    ReindeerSilicon: "トナカイ・シリコン",
    ReindeerSiliconDesc: "シリコンを消費するすべての建物は、代わりにトナカイを使用する（FREE POLICY）",
    ReindeerAluminum: "トナカイ・アルミ",
    ReindeerAluminumDesc: "アルミニウムを消費するすべての建物は、代わりにトナカイを使用します（FREE POLICY）",
    SantaClauseIsComing: "サンタクロースがやってくる",
    SantaClauseIsComingDesc:
        "サンタ工場はトナカイとおもちゃを消費し、サンタ、科学、カルチャーを生産します。サンタ工場はタイル修正値が最大です。おもちゃ工場は、おもちゃに加えてトナカイを生産する（FREE POLICY）",
    MetaRebranding: "メタ・リブランディング",
    MetaRebrandingDesc:
        "ソーシャルネットワーク社はメタIncに改名し、代わりにインターネット、ゲーム、スーパーコンピューター、ビットコイン、ドージコインを消費する",
    MetaInc: "メタInc",
    ImportSave: "セーブインポート",
    SaveVersionTooNew:
        "あなたのセーブバージョンは %{saveVersion} ですが、ゲームのバージョンは %{gameVersion}です。先にアップデートを行ってください",
    LeaderboardByFlag: "フラグによる集計",
    LeaderboardByMap: "マップによる集計",
    LeaderboardByFlagPlayerFlag: "フラグ",
    LeaderboardByFlagPayerCount: "#",
    LeaderboardByFlagPayerValuationPerHour: "V/H",
    LeaderboardByFlagPayerSwissMoney: "スイス",
    PlayerTradePriceFilter: "プライス・フィルター",
    ...
    InputCapacityOverride: "納入容量のオーバーライド",
    ...
    QuantumComputerLab: "量子コンピューターラボ",
